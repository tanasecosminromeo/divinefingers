...
export default class DivineStatusBarView {
  ...
  drawElement() {
    ...
    this.element.className = 'divine-statusbar inline-block';
    ...
    this.element.appendChild(document.createElement('div'));
		...
		this.status.oncontextmenu = function (){					
			atom.open({pathsToOpen: [atom.project.getPaths()[0]+"/.ftpconfig"], newWindow: false});
		}
